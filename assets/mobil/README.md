...
```bash
# CSS düzenledikten sonra HTML'e göm (sunucuda assets olmasa bile stil gelir)
node scripts/inline-mobil-css.js

# Tek dosya mobil (CSS+JS gömülü) — sadece erp-config.js ayrı gerekir
...
# Lite parçaları tek JS'te birleştirmek
